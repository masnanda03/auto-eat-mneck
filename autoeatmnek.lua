...
oras = os.time() - time
        local script = [[
			...
			@{
                ...
                value = "<:verify9:1138786804649164980> PTHT Completed Count : ]].. PTHT_COUNT ..[[ 
				<:verify9:1138786804649164980> PTHT Reach Total : ]].. TOTAL_PTHT ..[[ 
				==============================="
                inline = "false"
            }
			...
			@{
                ...
                value = "<:arrow:1145140876163686511> ]].. txt ..[[ 
				==============================="
                inline = "false"
            }
